...
<head>
    ...
    <title>RegistrarOffice - Home</title>
	 	...
	 	<div class="container text-center">
	 		<div class="row row-cols-5">
	 			<a href="student-add.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-user-plus fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				Register Students
	 			</a>
	 			<a href="student.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-user fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				All Students
	 			</a>
