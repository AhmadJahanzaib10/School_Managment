	 		...
	 		<table class="table table-bordered mt-3 n-table">
			  <thead>
			    <tr>
			      ...
			      <th scope="col">View Announcement</th>
			    </tr>
			  </thead>
			  <tbody>
			  	<?php $i = 0; foreach ($classes as $class) { ?>
			      	<?php 
			      		...
			      		foreach ($classesx as $class_id){
							  ...
							  <td>
						      	<a href="student_of_class.php?class_id=<?=$class['class_id']?>" class="btn btn-success">Add</a>
						      </td>		
						      <td>
						      	<a href="student-attendance.php?class_id=<?=$class['class_id']?>" class="btn btn-success">Add</a>
						      </td>      
						      <td>
						      	<a href="student_annoucement_view.php?grade_id=<?php print($grade['grade_id']) ?>&section_id=<?php print($section['section_id']) ?>" class="btn btn-success">View</a>
						      </td>      
							  </tr>			      				
			      			<?php 
			      			}
