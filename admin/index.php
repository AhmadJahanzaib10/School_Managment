	 	...
	 	<div class="container text-center">
	 		<div class="row row-cols-5">
	 			<a href="teacher.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-user-md fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				Teachers
	 			</a>
	 			<a href="student.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-graduation-cap fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				Students
	 			</a>
	 			<a href="grade.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-book fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				Grade
	 			</a>	 			
	 			<a href="registrar-office.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-pencil-square fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				Registrar Office
	 			</a>
	 			...
	 			<a href="section.php" class="col btn btn-dark m-2 py-3">
	 				<i class="fa fa-columns fs-1" aria-hidden="true" style="color:white;"></i>
	 				<br>
	 				Section
	 			</a>
